    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SalaDeCine>()
              ...
              {                  
                    new SalaDeCine{Id = 4, Nombre = "Multiplex", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-34.44574111834987, -58.86801623352025))},
                    new SalaDeCine{Id = 5, Nombre = "Cinepolis", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-34.44190200549196, -58.87110170270172))},
                    new SalaDeCine{Id = 6, Nombre = "Cinemark TOM", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-34.451205451449574, -58.72628767262729))}
              });
